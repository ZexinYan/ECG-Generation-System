...
class GeneratedTable:
    ...
    @staticmethod
    def table():
        if GeneratedTable._table is None:
            GeneratedTable._client = pymongo.MongoClient("mongodb://localhost:27017/")
            GeneratedTable._table = GeneratedTable._client[DataBaseConstant.DATABASE_NAME][DataBaseConstant.GENERATED_TABLE]
        return GeneratedTable._table
